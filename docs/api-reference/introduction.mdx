...
1. **Get an API Key**: Create an account on [Rippletide Platform](https://trust.rippletide.com/) and go to Settings to get your API key
...
- [Get Started](/docs) - Quick start guide
