...
Decision runtime lets you build agents that make **deterministic decisions** instead of probabilistic guesses. Pair it with a [Context Graph](/docs/mcp/overview) when your agent also needs persistent memory.
...
<Steps>
  <Step title="Create an agent">
    Start with an existing agent and define the behavior it should make deterministic.
  </Step>
