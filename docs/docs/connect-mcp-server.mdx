...
Connect an MCP server to inventory its tools and apply rules before a tool can take an action. [Test its rules](/docs/evaluate-improve) by invoking guarded tools through your MCP client and inspecting the decisions.
