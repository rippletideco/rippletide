...
<CardGroup cols={3}>
  <Card title="Eval" icon="chart-line">
    Run evaluations, view hallucination reports, and track agent accuracy over time. All from the dashboard.
  </Card>

  <Card title="Context Graph" icon="diagram-project">
    Visualize your agent's knowledge graph: entities, memories, and relationships displayed as an interactive graph.
  </Card>

  <Card title="Orchestration" icon="wand-magic-sparkles">
...
- You want to visualize and debug your agent's knowledge graph
