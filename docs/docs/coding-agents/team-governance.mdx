...
<Steps>
  <Step title="Define your standards">
    A team lead stores conventions in a Context Graph — naming rules, component patterns, architectural decisions. This can be done via the [dashboard](https://trust.rippletide.com) or automatically through the CLI with `npx rippletide-code@latest`.
  </Step>
