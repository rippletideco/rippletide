...
```bash
npx rippletide-code@latest connect --agent-id <agent_id> --read-only
```
...
<Steps>
  ...
  <Step title="Connect every engineer">
    ...
    ```bash
    npx rippletide-code@latest connect --agent-id <shared_agent_id> --read-only
    ```
...
npx rippletide-code@latest connect --agent-id team-standards-agent
...
npx rippletide-code@latest connect --agent-id team-standards-agent --read-only
...
```bash
npx rippletide-code@latest connect --agent-id <colleague_agent_id> --read-only
```
