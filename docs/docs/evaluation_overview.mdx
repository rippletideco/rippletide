...
Eval is the entry point to Rippletide. Before adding memory or decision runtime, start by testing what your agent already does. Rippletide evaluates your agent's responses against expected answers, detects hallucinations, and gives you a clear pass/fail report.
