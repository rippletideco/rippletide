...
Eval is the entry point to Rippletide. Before adding memory or orchestration, start by testing what your agent already does. Rippletide evaluates your agent's responses against expected answers, detects hallucinations, and gives you a clear pass/fail report.

Once you know where your agent stands, you can move to the [Context Graph](/docs/mcp/overview) for persistent memory and [Orchestration](/docs/hypergraph_overview) for deterministic decision-making.
...
<CardGroup cols={2}>
  <Card title="Context Graph" icon="diagram-project" href="/docs/mcp/overview">
    Give your agent persistent memory with a knowledge graph
  </Card>
